...
* @returns {string}
*/
  get_change_pubkey_message(layer_one_chain_id: number, verifying_contract: string): string;
}
/**
*/
...
* @returns {Promise<any>}
*/
  confirmFullExit(tx_hash: string, submitter_signature: string): Promise<any>;
/**
* @param {string} topic
...
*/
  submitterSignature(tx: any): TxZkLinkSignature;
}
/**
*/
...
* @param {number | undefined} [ts]
*/
  constructor(account_id: number, sub_account_id: number, to_chain_id: number, to_address: string, l2_source_token: number, fee: string, withdraw_fee_ratio: number, l1_target_token: number, amount: string, nonce: number, withdraw_to_l1: boolean, ts?: number);
/**
* @returns {Withdraw}
*/
  build(): Withdraw;
