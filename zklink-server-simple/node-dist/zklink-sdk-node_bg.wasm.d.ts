...
export function withdrawbuilder_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number): void;
...
export function rpcclient_getFastWithdrawTxs(a: number, b: number, c: number): number;
export function rpcclient_pullForwardTxs(a: number, b: number, c: number, d: number): number;
export function rpcclient_confirmFullExit(a: number, b: number, c: number, d: number, e: number): number;
...
export function signer_submitterSignature(a: number, b: number, c: number): void;
