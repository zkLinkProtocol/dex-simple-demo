...
/**
*/
module.exports.OracleType = Object.freeze({ Pyth:0,"0":"Pyth", });
/**
* A set of L2 transaction type supported by the zklink network.
*/
module.exports.ZkLinkTxType = Object.freeze({ Deposit:0,"0":"Deposit",FullExit:1,"1":"FullExit",ChangePubKey:2,"2":"ChangePubKey",Transfer:3,"3":"Transfer",Withdraw:4,"4":"Withdraw",ForcedExit:5,"5":"ForcedExit",OrderMatching:6,"6":"OrderMatching",AutoDeleveraging:7,"7":"AutoDeleveraging",ContractMatching:8,"8":"ContractMatching",Funding:9,"9":"Funding",Liquidation:10,"10":"Liquidation",UpdateGlobalVar:11,"11":"UpdateGlobalVar", });
/**
*/
...
class RpcClient {
    ...
    * @returns {Promise<any>}
    */
    sendTransaction(tx, l1_signature, l2_signature, oracle_signature) {
        let ptr0 = 0;
        ...
        let ptr2 = 0;
        if (!isLikeNone(oracle_signature)) {
            _assertClass(oracle_signature, TxOracleSignature);
            ptr2 = oracle_signature.__destroy_into_raw();
        }
        const ret = wasm.rpcclient_sendTransaction(this.__wbg_ptr, addHeapObject(tx), ptr0, ptr1, ptr2);
        return takeObject(ret);
    }
    /**
    * @returns {Promise<any>}
    ...
    * @returns {Promise<any>}
    */
    getFastWithdrawTxs(last_tx_timestamp, max_txs) {
        const ret = wasm.rpcclient_getFastWithdrawTxs(this.__wbg_ptr, last_tx_timestamp, max_txs);
        return takeObject(ret);
    }
    /**
    * @param {number} sub_account_id
    ...
    * @param {string} submitter_signature
    * @returns {Promise<any>}
    */
    confirmFullExit(tx_hash, submitter_signature) {
        const ptr0 = passStringToWasm0(tx_hash, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(submitter_signature, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.rpcclient_confirmFullExit(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    * @param {string} topic
...
class Signer {
    ...
    */
    submitterSignature(tx) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.signer_submitterSignature(retptr, this.__wbg_ptr, addHeapObject(tx));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
class TxOracleSignature {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_txoraclesignature_free(ptr);
    }
}
module.exports.TxOracleSignature = TxOracleSignature;
/**
*/
...
class WithdrawBuilder {
    ...
    * @param {number | undefined} [ts]
    */
    constructor(account_id, sub_account_id, to_chain_id, to_address, l2_source_token, fee, withdraw_fee_ratio, l1_target_token, amount, nonce, withdraw_to_l1, ts) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(to_address, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            ...
            const ptr2 = passStringToWasm0(amount, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
            const len2 = WASM_VECTOR_LEN;
            wasm.withdrawbuilder_new(retptr, account_id, sub_account_id, to_chain_id, ptr0, len0, l2_source_token, ptr1, len1, withdraw_fee_ratio, l1_target_token, ptr2, len2, nonce, withdraw_to_l1, !isLikeNone(ts), isLikeNone(ts) ? 0 : ts);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
...
module.exports.__wbindgen_closure_wrapper3938 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 643, __wbg_adapter_50);
    return addHeapObject(ret);
};

module.exports.__wbindgen_closure_wrapper7266 = function(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 1488, __wbg_adapter_53);
    return addHeapObject(ret);
};
