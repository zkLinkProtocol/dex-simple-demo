...
import BRAVE_ICON from 'assets/wallets/brave.svg'
...
import METAMASK_ICON from 'assets/wallets/metamask.svg'
import RABBY_ICON from 'assets/wallets/rabby.svg'
import TRUST_WALLET_ICON from 'assets/wallets/trustwallet.svg'
...
const InjectedWalletTable: {
  ...
  isBitKeep: { name: 'Bitget', icon: BITGET_ICON },
...
export const getIsBitgetWallet = () => Boolean(window.bitkeep?.ethereum)
